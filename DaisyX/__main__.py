...
PM_START_TEXT = """
Hello there, I'm [Zorase](https://telegra.ph/file/473cc17913393959e0667.jpg)
...
buttons = [
    ...
    [
        InlineKeyboardButton(
            text="💫 Add Zorase to your group 💫", url="t.me/TheVampireLadyBot?startgroup=true"
        ),
    ],
]
...
def DaisyX_about_callback(update, context):
    ...
    if query.data == "aboutmanu_":
        query.message.edit_text(
            ...
            f"\n\n 🔥 Join [Count Dracula](https://t.me/countdraculasupport) To Keep Yourself Updated About {dispatcher.bot.first_name} 🔥"
